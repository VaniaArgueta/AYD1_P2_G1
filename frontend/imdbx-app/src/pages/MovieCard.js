...
const MovieCard = props => {
    ...
    return (
        <div className="col-sm-6 col-md-8 movie-card">
            <div className="movie-card-container border-gray rounded border mx-2 d-flex flex-row align-items-center p-0 bg-light">
                <div className="h-100 position-relative border-gray border-right px-2 bg-white rounded-left">
                    <img src={ilustracion} alt="ProfilePic" className='img-thumbnail img-fluid rounded' style={{ maxWidth: "100px", maxHeight: "88px", padding: "2px" }} />
                </div>
